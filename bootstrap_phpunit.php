...
$app_path     = rtrim((string) $_SERVER['app_path'], '/').'/';
$package_path = rtrim((string) $_SERVER['package_path'], '/').'/';
$vendor_path  = rtrim((string) $_SERVER['vendor_path'], '/').'/';
$core_path    = rtrim((string) $_SERVER['core_path'], '/').'/';
